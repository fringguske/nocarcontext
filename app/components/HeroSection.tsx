    ...
    <section className="relative w-full flex flex-col items-center">
      ...
      <div className="relative w-full mt-20 md:mt-24">
        ...
        <img
          src="/1080x360.jfif"
          alt="Hero Background"
          className="w-full h-auto block min-h-[280px] sm:min-h-0 object-cover"
        />
        {/* Dark Overlay */}
        ...
        <div className="absolute inset-0 z-10 flex items-center">
          <div className="w-full max-w-7xl mx-auto px-6">
            <div className="flex flex-col gap-3 md:gap-6 max-w-2xl animate-fade-in">
              ...
              <h1 className="font-outfit text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tight text-white">
                Beyond <br />
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-1 md:pt-2">
                ...
                <button className="hidden sm:block w-full sm:w-auto px-6 md:px-10 py-3 md:py-4 rounded-2xl font-bold text-base md:text-lg text-white hover:bg-white/10 border border-white/20 transition-all duration-500 backdrop-blur-md">
                  Contact VIP Sales
                </button>
              </div>
            </div>
