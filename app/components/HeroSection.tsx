...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full flex flex-col items-center">
        ...
        <div className="absolute inset-0 z-10 flex items-center">
          <div className="w-full max-w-7xl mx-auto px-6">
            <div className="flex flex-col gap-4 md:gap-6 max-w-2xl animate-fade-in">
              ...
              {/* Description + Buttons - desktop only (on image) */}
              <div className="hidden md:block">
                <p className="text-lg text-slate-300 leading-relaxed max-w-lg font-medium mb-6">
                  Curated precision. Unrivaled luxury. Discover a collection of the world&apos;s finest automotive masterpieces.
                </p>
                <div className="flex flex-row gap-3">
                  <button className="px-10 py-4 rounded-2xl bg-blue-600 text-white font-black text-lg flex items-center gap-3 group transition-all duration-500 hover:bg-blue-500 hover:shadow-2xl hover:shadow-blue-500/40 hover:-translate-y-1">
                    Explore Fleet
                  ...
                  <button className="px-10 py-4 rounded-2xl font-bold text-lg text-white hover:bg-white/10 border border-white/20 transition-all duration-500 backdrop-blur-md">
                    Contact VIP Sales
                  </button>
                </div>
              </div>
      ...
      {/* Mobile CTA section - below the image, mobile only */}
      <div className="block md:hidden w-full bg-slate-900 px-6 py-8">
        <p className="text-base text-slate-300 leading-relaxed font-medium mb-6">
          Curated precision. Unrivaled luxury. Discover a collection of the world&apos;s finest automotive masterpieces.
        </p>
        <div className="flex flex-col gap-3">
          <button className="w-full px-6 py-3 rounded-2xl bg-blue-600 text-white font-black text-base flex items-center justify-center gap-3 group transition-all duration-500 hover:bg-blue-500">
            Explore Fleet
            <div className="bg-white/20 p-1 rounded-lg transition-transform duration-500 group-hover:translate-x-2">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          <button className="w-full px-6 py-3 rounded-2xl font-bold text-base text-white hover:bg-white/10 border border-white/20 transition-all duration-500">
            Contact VIP Sales
          </button>
        </div>
      </div>
